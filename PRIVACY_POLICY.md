...
これらの処理はすべてローカル環境内で完結しており、
外部サーバーへの通信、第三者へのデータ提供、追跡、分析、広告目的での利用は行いません。

また、本拡張機能は YouTube API を使用していません。
...
No data is sent to external servers, shared with third parties,
or used for tracking, analytics, or advertising purposes.

This extension does not use the YouTube API.
